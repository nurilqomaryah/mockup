...
@section('main')
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div id="grafik-hari-penugasan-2" style="min-height: 40vh; width: 100%;"></div>
                </div>
                <div class="card-body">
                    <div id="grafik-hari-dinas-2" style="min-height: 40vh; width: 100%;"></div>
                </div>
            </div>
        </div>
    </div>
    <script>
        $(document).ready(function(){
            ...
            Highcharts.chart('grafik-hari-penugasan-2', {
                colors: ['#454cb3'],
                chart: {
                    type: 'column'
                },
                ...
                subtitle: {
                    text: 'Bidang Pengembangan dan Inovasi'
                },
                xAxis: {
                    categories: [
            ...
            Highcharts.chart('grafik-hari-dinas-2', {
                colors: ['#fea00a'],
                chart: {
                    type: 'column'
                },
